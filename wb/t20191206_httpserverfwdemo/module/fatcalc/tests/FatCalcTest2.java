package wb.t20191206_httpserverfwdemo.module.fatcalc.tests;
...
public class FatCalcTest2 {
	...
	private static void test01() throws Exception {
		for(int c = 0; c < 1000000; c++) {
...

			{
				...
				String ans2 = new FatCalc().calc(a, "+", b);
	...
	private static String test01_randSingleIntOperand() {
		...
		case 1:
			return
					SecurityTools.makePassword(StringTools.DECIMAL, SecurityTools.cRandom.getRangeInt(1, 100)) +
	...
	private static String keisan(String a, String operator, String b) throws Exception {
		String command = "C:/Factory/Tools/Keisan.exe //O C:/temp/1.tmp /B 30 " + a + " " + operator + " " + b;
