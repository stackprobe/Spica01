...
public class StringTools {
	...
	public static final String MBC_PUNCT =
			...
			getString_SJISCodeRange_re(0x81, 0xc8, 0xce) + // 理論
			...
			getString_SJISCodeRange_re(0x83, 0x9f, 0xb6) + // ギリシャ語 大文字
			getString_SJISCodeRange_re(0x83, 0xbf, 0xd6) + // ギリシャ語 小文字
			getString_SJISCodeRange_re(0x84, 0x40, 0x60) + // キリル文字 大文字
			getString_SJISCodeRange_re(0x84, 0x70, 0x7e) + // キリル文字 小文字(1)
			getString_SJISCodeRange_re(0x84, 0x80, 0x91) + // キリル文字 小文字(2)
