...
public class ZipToolsTest {
	...
	private static void test01() throws Exception {
		try(WorkingDir wd = new WorkingDir()) {
			...
			FileTools.writeAllText(wd.getPath("root/a/いろは123漢字abc.txt"), "789abcあああああいいいいい", StringTools.CHARSET_UTF8); // orig: FileTools.writeAllText(wd.getPath("root/a/\u3044\u308d\u306f123\u6f22\u5b57abc.txt"), "789abc\u3042\u3042\u3042\u3042\u3042\u3044\u3044\u3044\u3044\u3044", StringTools.CHARSET_UTF8);
